...
COMPILER=clang
LINKER=""
COMPILERDIR="/workspace/DK-KEENEL/proton-clang"
...
then
    ...
    cp out/arch/arm64/boot/Image.gz-dtb out/outputs/${PHONE}/9.1.24-SE/Image.gz-dtb.se.old
    ...
    then
        ...
        echo "Build succesful"
        cp out/arch/arm64/boot/Image.gz-dtb out/outputs/${PHONE}/9.1.24-NSE/Image.gz-dtb.nse.old
        ...
        then
            ...
            echo "Build succesful"
            cp out/arch/arm64/boot/Image.gz-dtb out/outputs/${PHONE}/10.3.7-SE/Image.gz-dtb.se.new
            ...
            then
                ...
                echo "Build succesful"
                cp out/arch/arm64/boot/Image.gz-dtb out/outputs/${PHONE}/10.3.7-NSE/Image.gz-dtb.nse.new
            fi
        fi
    fi
fi
